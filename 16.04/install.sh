...
function install_php {
    apt-get install -y php7.2-bcmath php7.2-cli php7.2-sqlsrv php7.2-pdo_sqlsrv php7.2-curl php7.2-fpm php7.2-gd php7.2-mbstring php7.2-redis php7.2-sqlsrv php7.2-pdo_sqlsrv php7.2-mysql php7.2-opcache php7.2-pgsql php7.2-readline php7.2-xml php7.2-zip php7.2-sqlite3
}
